...
export function ParticleTextEffect({ word = "HELLO" }) {
  ...
  const renderWord = (text, canvas) => {
    ...
    // Generate new color (cool tones to match the portfolio vibe: blue/purple/teal)
    const newColor = {
  ...
  useEffect(() => {
    ...
    // Initialize with the provided word
